#requires -Version 3.0 -Modules VMware.VimAutomation.Core, VMware.VimAutomation.Vds,VMware.PowerCLI, ReportHTML
...
$stigsettings = @{
  ...
  stigVibRE             = 'dod-esxi65-stig-re'
  stigVibRD             = 'dod-esxi65-stig-rd'
  esxAdminsGroup        = @{
    'Config.HostAgent.plugins.hostsvc.esxAdminsGroup' = $esxAdminGroup
  }
  ...
  adDomain              = 'corp.local'
  certAuthName          = 'O=U.S. Government'
  DCUIAccess            = @{
    'DCUI.Access' = 'root'
  }
  vibacceptlevel        = 'PartnerSupported'
  accountLockFailures   = @{
...
"@
  ...
  if ($WebRequest.ServicePoint.Certificate -ne $null) 
  {
    ...
    try 
    {
      $SAN = ($Cert.Extensions | Where-Object -FilterScript {
    ...
    $chain = New-Object -TypeName Security.Cryptography.X509Certificates.X509Chain -ArgumentList (!$UseUserContext)
...
Function Write-ToConsole
{
  ...
  (
    ...
    [Parameter(ParameterSetName = 'Set 2')][switch]$Green,
    [Parameter(ParameterSetName = 'Set 1')]
    [Parameter(ParameterSetName = 'Set 3')][switch]$Red
  )
  $Color = 'Gray'
...
If(-not [System.Net.ServicePointManager].DeclaredProperties | Where-Object -FilterScript {
    $_.name -eq 'CertificatePolicy'
})
{
  Add-Type -TypeDefinition @"
    using System.Net;
...
Catch
{
  Write-Error -Message 'Failed to load modules'
...
Catch
{
  Write-Error -Message 'Failed to validate or create specified report directory'
  Write-Error -Message $_.Exception
  Exit -1
}
...
Catch
{
  Write-Error -Message "Failed to connect to $vcenter"
  Write-Error -Message $_.Exception
  Exit -1
}
...
Try
{
  ...
  Sort-Object -Property Name -ErrorAction Stop
  $vmhostsv = $vmhosts |
  Get-View |
  Sort-Object -Property Name -ErrorAction Stop
...
Catch
{
  Write-Error -Message "Failed to gather info on environment in $vcenter"
  Write-Error -Message $_.Exception
...
Try
{
  ...
  If($V94563)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmIsoCopyDisable.Values
    ...
    ForEach($vm in $vmsv)
    {
      ...
      {
        $currentvalue = $vm.config.extraconfig | Where-Object -FilterScript {
          $_.key -eq "$settingname"
        }
        If($currentvalue.value -ne $settingvalue)
        {
          $vmsarray += New-Object -TypeName PSObject -Property ([ordered]@{
              'Name'    = $vm.name
    ...
    $vmsarray01 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
  ...
  Else
  {
    Write-ToConsole -Details "...Skipping disabled control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title" -Red
  }
}
Catch
{
  Write-Error -Message "Failed to check control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title on $($vm.name)"
  Write-Error -Message $_.Exception
  Write-ToConsole "...Disconnecting from vCenter Server $vcenter"
  Disconnect-VIServer -Server $vcenter -Force -Confirm:$false
  Exit -1
...
Try
{
  ...
  If($V94565)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmIsoDndDisable.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray02 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
  ...
  Else
  {
    Write-ToConsole -Details "...Skipping disabled control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title" -Color Red
  }
}
Catch
{
...
Try
{
  ...
  If($V94569)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmIsoPasteDisable.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray04 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
  ...
  Else
  {
    Write-ToConsole -d "...Skipping disabled control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title" -Re
  }
}
Catch
{
...
Try
{
  ...
  If($V94571)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmIsoDiskShrink.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray05 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
  ...
  Else
  {
    Write-ToConsole -Red -Details "...Skipping disabled control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
  }
}
Catch
{
...
Try
{
  ...
  If($V94573)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmIsoDiskWiper.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray06 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94575)
  {
    ...
    $vmsarray07 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94577)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmIsoHgfsDisable.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray08 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94613)
  {
    ...
    $vmsarray28 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94615)
  {
    ...
    $vmsarray29 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94617)
  {
    ...
    {
      Write-ToConsole "...Checking VM $($vm.Name) for $Title"
      $vmparrallel = $vm.config.hardware.device.deviceinfo | Where-Object -FilterScript {
        $_.Label -match 'parallel'
      }
      If($vmparrallel)
      {
        $vmsarray += New-Object -TypeName PSObject -Property ([ordered]@{
    ...
    $vmsarray30 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94619)
  {
    ...
    {
      Write-ToConsole "...Checking VM $($vm.Name) for $Title"
      $vmserial = $vm.config.hardware.device.deviceinfo | Where-Object -FilterScript {
        $_.Label -match 'serial'
      }
      If($vmserial)
      {
        $vmsarray += New-Object -TypeName PSObject -Property ([ordered]@{
    ...
    $vmsarray31 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94621)
  {
    ...
    {
      Write-ToConsole "...Checking VM $($vm.Name) for $Title"
      $vmusb = $vm.config.hardware.device.deviceinfo | Where-Object -FilterScript {
        $_.Label -match 'USB con*'
      }
      If($vmusb)
      {
        $vmsarray += New-Object -TypeName PSObject -Property ([ordered]@{
    ...
    $vmsarray32 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94623)
  {
    ...
    $vmsarray33 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94625)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmRemoteVnc.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray34 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94627)
  {
    ...
    $vmsarray36 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94629)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmDevConnDisable.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray37 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94631)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmEnableHostInfo.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray39 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94633)
  {
    ...
    $vmsarray40 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94635)
  {
    ...
    {
      Write-ToConsole "...Checking VM $($vm.Name) for $settingname"
      $dvFilters = $vm.config.extraconfig | Where-Object -FilterScript {
        $_.key -like $settingname
      }            
      If($dvFilters)
      {
        $currentvalue = $vm.config.extraconfig | Where-Object -FilterScript {
    ...
    $vmsarray41 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94641)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmGuestLock.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray44 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94643)
  {
    ...
    $settingvalue = [bool]$stigsettings.vmMks3D.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $vmsarray = @()
    ForEach($vm in $vmsv)
    {
    ...
    $vmsarray45 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94645)
  {
    ...
    $vmsarray46 = Set-TableRowColor -ArrayOfObjects $vmsarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93949)
  {
    ...
    ForEach($vmhost in $vmhostsv)
    {
      ...
      {
        $esxiarray += New-Object -TypeName PSObject -Property ([ordered]@{
            'Name'    = $vmhost.name
    ...
    $esxiarray01 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93951)
  {
    ...
    ForEach($vmhost in $vmhostsv)
    {
      ...
      {
        $currentvalue = $vmhost.Config.option | Where-Object -FilterScript {
          $_.key -eq "$settingname"
        }
        If($currentvalue.value -ne $settingvalue)
        {
    ...
    $esxiarray02 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93953)
  {
    ...
    $esxiarray03 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93955)
  {
    ...
    $esxiarray04 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93957)
  {
    ...
    $esxiarray05 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93959)
  {
    ...
    $esxiarray06 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93961)
  {
    ...
    ForEach($vmhost in $vmhosts)
    {
      ...
      $results = $esxcli.software.vib.list.Invoke() | Where-Object -FilterScript {
        $_.Name -eq $stigsettings.stigVibRE -or $_.Name -eq $stigsettings.stigVibRD
      }
      If($results)
      {
        $esxiarray += New-Object -TypeName PSObject -Property ([ordered]@{
    ...
    $esxiarray07 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93963)
  {
    ...
    $esxiarray08 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93965)
  {
    ...
    $esxiarray09 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93967)
  {
    ...
    $esxiarray10 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93969)
  {
    ...
    $esxiarray11 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93971)
  {
    ...
    $esxiarray12 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93973)
  {
    ...
    $esxiarray13 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93975)
  {
    ...
    $esxiarray14 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93977)
  {
    ...
    $esxiarray15 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93979)
  {
    ...
    $esxiarray16 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93981)
  {
    ...
    $esxiarray17 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93983)
  {
    ...
    $esxiarray18 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
  ...
  Else
  {
    Write-ToConsole -Red -Details  "...Skipping disabled control with Vulnerability ID:$VULID STIG ID:$STIGID Severity:$Severity with Title: $Title"
  }
}
Catch
{
  Write-Error -Message "Failed to check control with Vulnerability ID:$VULID STIG ID:$STIGID Severity:$Severity with Title: $Title on $($vm.name)"
  Write-Error -Message $_.Exception
  Write-ToConsole "...Disconnecting from vCenter Server $vcenter"
  Disconnect-VIServer -Server $vcenter -Force -Confirm:$false
  Exit -1
...
Try
{
  ...
  If($V93985)
  {
    ...
    $esxiarray19 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93987)
  {
    ...
    $esxiarray20 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93989)
  {
    ...
    $esxiarray21 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93991)
  {
    ...
    $esxiarray22 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93993)
  {
    ...
    $esxiarray23 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93995)
  {
    ...
    $esxiarray24 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93997)
  {
    ...
    $esxiarray25 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V93999)
  {
    ...
    $esxiarray26 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94001)
  {
    ...
    $esxiarray27 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94003)
  {
    ...
    $esxiarray28 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94005)
  {
    ...
    Write-ToConsole -Red -Details  "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID Severity:$Severity with Title: $Title"
    $esxiarray = @()
    ForEach($vmhost in $vmhosts)
    {
      Write-ToConsole "...Checking ESXi Host $($vmhost.Name) for $Title"
    ...
    $esxiarray29 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94007)
  {
    ...
    $esxiarray30 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94009)
  {
    ...
    $esxiarray31 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94011)
  {
    ...
    $esxiarray32 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94013)
  {
    ...
    $esxiarray33 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94015)
  {
    ...
    $settingvalue = [bool]$stigsettings.enableMob.Values
    Write-ToConsole "...Checking STIG Control with Vulnerability ID:$VULID STIG ID:$STIGID with Title: $Title"
    $esxiarray = @()
    ForEach($vmhost in $vmhostsv)
    {
    ...
    $esxiarray34 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94017)
  {
    ...
    {
      Write-ToConsole "...Checking ESXi Host $($vmhost.Name) for $Title"
      $vmhostservice = $vmhost |
      Get-VMHostService |
      Where-Object -FilterScript {
        $_.Label -eq $servicename
      }      
    ...
    $esxiarray35 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94019)
  {
    ...
    $esxiarray36 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94021)
  {
    ...
    $esxiarray37 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94023)
  {
    ...
    $esxiarray38 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94025)
  {
    ...
    $esxiarray39 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94029)
  {
    ...
    $esxiarray41 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94031)
  {
    ...
    $esxiarray42 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94033)
  {
    ...
    $esxiarray43 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94035)
  {
    ...
    ForEach($vmhost in $vmhosts)
    {
      Write-ToConsole "...Checking ESXi Host $($vmhost.Name) for $Title"        
      $esxcli = Get-EsxCli -VMHost $vmhost -V2
      $results = $esxcli.system.coredump.partition.list.Invoke() | Where-Object -FilterScript {
        $_.Active -eq 'true'
      }
      If($results)
      {
    ...
    $esxiarray44 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94037)
  {
    ...
    $esxiarray45 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94039)
  {
    ...
    $esxiarray46 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94041)
  {
    ...
    $esxiarray47 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94043)
  {
    ...
    $esxiarray48 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94045)
  {
    ...
    $esxiarray49 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94047)
  {
    ...
    $esxiarray50 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94051)
  {
    ...
    $esxiarray52 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94053)
  {
    ...
    ForEach($vmhost in $vmhosts)
    {
      Write-ToConsole "...Checking ESXi Host $($vmhost.Name) for $Title"
      $esxcli = Get-EsxCli -VMHost $vmhost -V2
      $results = $esxcli.system.snmp.get.Invoke() | Where-Object -FilterScript {
        $_.enable -eq 'true'
      }
    ...
    $esxiarray53 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94055)
  {
    ...
    $esxiarray54 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94057)
  {
    ...
    $esxiarray55 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94059)
  {
    ...
    $esxiarray56 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94061)
  {
    ...
    $esxiarray57 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94063)
  {
    ...
    $esxiarray58 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94065)
  {
    ...
    $esxiarray59 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94067)
  {
    ...
    $esxiarray60 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94069)
  {
    ...
    $esxiarray61 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94071)
  {
    ...
    $esxiarray62 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94073)
  {
    ...
    $esxiarray63 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94075)
  {
    ...
    $esxiarray64 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94077)
  {
    ...
    $esxiarray65 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94479)
  {
    ...
    $esxiarray72 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94483)
  {
    ...
    $esxiarray74 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94487)
  {
    ...
    $esxiarray76 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94489)
  {
    ...
    $esxiarray78 = Set-TableRowColor -ArrayOfObjects $esxiarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94725)
  {
    ...
    Select-Object -Property Role, Principal, Entity, Propagate, IsGroup
    ForEach($perm in $perms)
    {
      $vcarray += New-Object -TypeName PSObject -Property ([ordered]@{
          'Name'    = $vcenter
          'Role'    = $perm.role
    ...
    $vcarray05 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94727)
  {
    ...
    $vcarray07 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94735)
  {
    ...
    $vcarray12 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94737)
  {
    ...
    $vcarray13 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94739)
  {
    ...
    $vcarray14 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94741)
  {
    ...
    $vcarray15 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94743)
  {
    ...
    $vcarray16 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94745)
  {
    ...
    $vcarray17 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94747)
  {
    ...
    $vcarray18 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94749)
  {
    ...
    $vcarray19 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94751)
  {
    ...
    $vcarray20 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
Try
{
  ...
  If($V94781)
  {
    ...
    $vcarray36 = Set-TableRowColor -ArrayOfObjects $vcarray -Red '$this.Compliant -eq $false' | Sort-Object -Property @{
      Expression = {
        $_.RowColor
      }
      Ascending  = $false
...
$vmsarrayallcompliantcount = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true
}).count
$vmsarrayallnoncompliantcount = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false
}).count

##Virtual Machine Compliance By Severity
$vmscompliantcountcat1 = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT I'
}).count
$vmsnoncompliantcountcat1 = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT I'
}).count
$vmscompliantcountcat2 = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT II'
}).count
$vmsnoncompliantcountcat2 = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT II'
}).count
$vmscompliantcountcat3 = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT III'
}).count
$vmsnoncompliantcountcat3 = @($vmsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT III'
}).count

#Generate VM Compliance table
$vmcomptable = New-Object -TypeName 'System.Collections.Generic.List[System.Object]'
...
$vmcomptablesev = New-Object -TypeName 'System.Collections.Generic.List[System.Object]'
...
$vmhostsarrayallcompliantcount = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true
}).count
$vmhostsarrayallnoncompliantcount = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false
}).count

##ESXi Compliance By Severity
$vmhostscompliantcountcat1 = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT I'
}).count
$vmhostsnoncompliantcountcat1 = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT I'
}).count
$vmhostscompliantcountcat2 = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT II'
}).count
$vmhostsnoncompliantcountcat2 = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT II'
}).count
$vmhostscompliantcountcat3 = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT III'
}).count
$vmhostsnoncompliantcountcat3 = @($vmhostsarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT III'
}).count

#Generate ESXi Compliance table
$vmhostcomptable = New-Object -TypeName 'System.Collections.Generic.List[System.Object]'
...
$vmhostcomptablesev = New-Object -TypeName 'System.Collections.Generic.List[System.Object]'
...
$vcarrayallcompliantcount = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true
}).count
$vcarrayallnoncompliantcount = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false
}).count

##Virtual Machine Compliance By Severity
$vccompliantcountcat1 = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT I'
}).count
$vcnoncompliantcountcat1 = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT I'
}).count
$vccompliantcountcat2 = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT II'
}).count
$vcnoncompliantcountcat2 = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT II'
}).count
$vccompliantcountcat3 = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $true -and $_.Severity -eq 'CAT III'
}).count
$vcnoncompliantcountcat3 = @($vcarrayall | Where-Object -FilterScript {
    $_.Compliant -eq $false -and $_.Severity -eq 'CAT III'
}).count

#Generate vCenter Compliance table
$vccomptable = New-Object -TypeName 'System.Collections.Generic.List[System.Object]'
...
$vccomptablesev = New-Object -TypeName 'System.Collections.Generic.List[System.Object]'
...
$envDataTable = New-Object -TypeName 'System.Collections.Generic.List[System.Object]'
